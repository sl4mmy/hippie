...
public class IntegrationSmokeTests {
        static {
                ...
                System.setProperty("hippie.nagios.password", "ABC123");

                // Optional JVM/System properties you can also set if
                // you need to override the defaults:
                // - hippie.nagios.port (default: 5667)
                // - hippie.nagios.timeout.connection (default: 5000 ms)
                // - hippie.nagios.timeout.response (default: 15000 ms)
        }
        ...
        public void awesomeServiceShouldBeAvailable() throws Exception {
                ...
                // TODO: figure out the correct order to call of these
                // calls:
                /*
